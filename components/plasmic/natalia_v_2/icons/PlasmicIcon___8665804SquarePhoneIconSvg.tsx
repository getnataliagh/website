...
export type _8665804SquarePhoneIconSvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function _8665804SquarePhoneIconSvgIcon(
  props: _8665804SquarePhoneIconSvgIconProps
) {
...
export default _8665804SquarePhoneIconSvgIcon;
/* prettier-ignore-end */
