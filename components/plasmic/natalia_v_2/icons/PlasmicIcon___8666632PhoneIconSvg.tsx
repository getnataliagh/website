...
export type _8666632PhoneIconSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function _8666632PhoneIconSvgIcon(props: _8666632PhoneIconSvgIconProps) {
...
export default _8666632PhoneIconSvgIcon;
/* prettier-ignore-end */
