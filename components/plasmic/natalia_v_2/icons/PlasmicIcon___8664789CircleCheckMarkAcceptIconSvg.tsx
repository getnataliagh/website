...
export type _8664789CircleCheckMarkAcceptIconSvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function _8664789CircleCheckMarkAcceptIconSvgIcon(
  props: _8664789CircleCheckMarkAcceptIconSvgIconProps
) {
...
export default _8664789CircleCheckMarkAcceptIconSvgIcon;
/* prettier-ignore-end */
