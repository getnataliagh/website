...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: uxZHtxwstTTQ/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__n8Eh)}
                    label={"Item 3"}
                    value={"item3"}
                  />
