...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: lI42RdYzTBYP/css
...
function PlasmicPriceSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__eaCez)}>
        <div className={classNames(projectcss.all, sty.freeBox__v7La5)}>
          <PriceCard
            borders={["flatLeft"]}
            className={classNames("__wab_instance", sty.priceCard__reVyC)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__dbFa)}>
          <div className={classNames(projectcss.all, sty.freeBox__bLa5N)}>
            <div
          ...
          <PriceCard
            borders={["flatCenter"]}
            className={classNames("__wab_instance", sty.priceCard__kweSg)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__ys10)}>
          <PriceCard
            ...
            className={classNames("__wab_instance", sty.priceCard__jrKwB)}
          />
        </div>
      </div>
    </div>
