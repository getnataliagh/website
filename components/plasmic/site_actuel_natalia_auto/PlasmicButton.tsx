...
import sty from "./PlasmicButton.module.css"; // plasmic-import: TU5A2-p6WFJJ/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__e5Yf0, {
          [sty.freeBoxcolor_neutral__e5Yf0DDvDj]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__e5Yf0WUqMkZHzct]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__e5Yf0WUKcw]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__e5Yf0CWYc]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__e5Yf050Smq]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__e5Yf0U6Hy]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__e5Yf05HkV]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__e5Yf0ZHzct]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_soft__e5Yf0SFwyY]: hasVariant($state, "type", "soft")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__weLwk, {
            [sty.freeBoxcolor_neutral__weLwkDDvDj]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__weLwkDDvDjSFwyY]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__weLwk429Ou]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__weLwkCWYc]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__weLwkU6Hy]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__weLwk5HkV]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__weLwkzHzct]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__ovre, {
            [sty.freeBoxiconEnd__ovre7Q63X]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__ovrecWYc]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__ovreu6Hy]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__ovre5HkV]: hasVariant(
              $state,
              "size",
              "small"
            )
