...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: zCpiUw2n1w7Y/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__ussAy)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__cUqPi)}>
            <div
              className={classNames(
                projectcss.all,
