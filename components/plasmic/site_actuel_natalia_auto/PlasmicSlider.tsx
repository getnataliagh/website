...
import SliderThumb from "../../SliderThumb"; // plasmic-import: eOzTfaTKCJhK/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: bEfeBjuT20IG/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox__vEjUo)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__rl27J)}>
        <div
