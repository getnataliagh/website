...
export type CalendarLinesPenSvgrepoComSvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function CalendarLinesPenSvgrepoComSvgIcon(
  props: CalendarLinesPenSvgrepoComSvgIconProps
) {
...
export default CalendarLinesPenSvgrepoComSvgIcon;
/* prettier-ignore-end */
