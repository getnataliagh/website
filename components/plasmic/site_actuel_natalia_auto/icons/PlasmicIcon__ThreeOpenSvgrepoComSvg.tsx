...
export type ThreeOpenSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function ThreeOpenSvgrepoComSvgIcon(
  props: ThreeOpenSvgrepoComSvgIconProps
) {
...
export default ThreeOpenSvgrepoComSvgIcon;
/* prettier-ignore-end */
