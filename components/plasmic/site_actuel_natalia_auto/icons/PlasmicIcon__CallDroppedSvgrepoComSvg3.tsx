...
export type CallDroppedSvgrepoComSvg3IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function CallDroppedSvgrepoComSvg3Icon(
  props: CallDroppedSvgrepoComSvg3IconProps
) {
...
export default CallDroppedSvgrepoComSvg3Icon;
/* prettier-ignore-end */
