...
export type FourOpenSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FourOpenSvgrepoComSvgIcon(
  props: FourOpenSvgrepoComSvgIconProps
) {
...
export default FourOpenSvgrepoComSvgIcon;
/* prettier-ignore-end */
