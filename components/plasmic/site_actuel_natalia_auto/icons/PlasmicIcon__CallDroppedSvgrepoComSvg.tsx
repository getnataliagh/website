...
export type CallDroppedSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function CallDroppedSvgrepoComSvgIcon(
  props: CallDroppedSvgrepoComSvgIconProps
) {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth={"1.5"}
        d={
          "M15 4v1c0 1.886 0 2.828.586 3.414S17.115 9 19 9h1.5m0 0L18 7m2.5 2L18 11"
        }
      ></path>
...
export default CallDroppedSvgrepoComSvgIcon;
/* prettier-ignore-end */
