...
export type DataIntegrationHubSvgrepoComSvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function DataIntegrationHubSvgrepoComSvgIcon(
  props: DataIntegrationHubSvgrepoComSvgIconProps
) {
...
export default DataIntegrationHubSvgrepoComSvgIcon;
/* prettier-ignore-end */
