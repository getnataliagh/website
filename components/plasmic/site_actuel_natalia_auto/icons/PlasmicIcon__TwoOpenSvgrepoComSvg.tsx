...
export type TwoOpenSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TwoOpenSvgrepoComSvgIcon(props: TwoOpenSvgrepoComSvgIconProps) {
...
export default TwoOpenSvgrepoComSvgIcon;
/* prettier-ignore-end */
