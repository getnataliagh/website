...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: g1wngd-Tig8P/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__r6Jgx)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column__urCJ)}>
            <h5
